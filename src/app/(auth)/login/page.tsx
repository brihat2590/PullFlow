    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900 text-white">
      <div className="max-w-md w-full mx-auto p-8 border border-gray-700 bg-gray-800 rounded-xl shadow-2xl text-center">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white text-gray-900 font-semibold rounded-lg hover:bg-gray-100 transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
        >
          {/* GitHub Icon */}
